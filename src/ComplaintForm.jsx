...
const ComplaintForm = ({ onNavigateHome }) => {
            ...
            <div className="flex items-center justify-between">
              ...
              {onNavigateHome && (
                <button
                  ...
                  className="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200 flex items-center space-x-2 backdrop-blur-sm border border-white/20"
                >
