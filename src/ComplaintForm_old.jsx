        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
          ...
          <div className="form-group">
            <label htmlFor="complaintId">
              Complaint ID <span className="optional">(auto-generated if empty)</span>
            </label>
            <input
              type="text"
              id="complaintId"
          ...
          <div className="form-group">
            <label htmlFor="screenshot">
              Screenshot <span className="optional">(optional - text will be auto-extracted)</span>
            </label>
            <input
              type="file"
              id="screenshot"
              ...
              <div className="file-preview">
                ...
                <button 
                  ...
                  onClick={() => {
                    setFormData(prev => ({...prev, screenshot: null, fraudMessage: ''}));
                    document.getElementById('screenshot').value = '';
                    setSubmitMessage(''); // Clear any OCR error messages
                  }}
          ...
          <div className="form-group">
            <label htmlFor="fraudMessage">
              Fraud Message <span className="optional">(auto-extracted from image or manual entry)</span>
            </label>
            <textarea
              id="fraudMessage"
              name="fraudMessage"
              ...
              placeholder="Additional fraud-related information will appear here when you upload an image, or you can enter it manually..."
              rows="4"
              className="fraud-message-textarea"
            />
            {formData.fraudMessage && (
              <div className="fraud-message-info">
                💡 This information will be sent to the agent as additional context about potential fraud.
              </div>
            )}
          </div>
